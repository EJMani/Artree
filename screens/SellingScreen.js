...
function CommissionsScreen() {
    return (
        <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', backgroundColor: "#1f1e49" }}>
            <Text style={styles.text}>Commission 1{"\n\t\t\t\t"} artist: nick {"\n\t\t\t\t"} in progress... {"\n\t\t\t\t"} cost: $35.00</Text>
            <View style={styles.otherButtons}><SubmitProduct></SubmitProduct></View>
            <Text style={styles.text}>Commission 2{"\n\t\t\t\t"} artist: joeP82 {"\n\t\t\t\t"} completed {"\n\t\t\t\t"} cost: $872.55</Text>
            <View style={styles.buySellButton}><SellingButton></SellingButton></View>
        </View>
    );
}
...
function AuctionsScreen() {
    return (
        <View style={{ flex: 1, justifyContent: 'flex-start', alignItems: 'center', backgroundColor: "#1f1e49", }}>
            <Text style={styles.text}>Auction 1{"\n\t\t\t\t"} buyer: alphaDavee42 {"\n\t\t\t\t"} current bid: $18.50 {"\n\t\t\t\t"} time remaining: 5hrs 10min</Text>
            <Text style={styles.otherText}>{"\t\t\t\t"}you are winning this auction</Text>
            <Text style={styles.text}>Auction 2{"\n\t\t\t\t"} buyer: beyondReality5 {"\n\t\t\t\t"} current bid: $156.00 {"\n\t\t\t\t"} time remaining:{"\n\t\t\t\t"} 3days 4hrs </Text>
            <View style={styles.otherButtons}><BidAgain></BidAgain></View>
            <Text style={styles.text}>Auction 3{"\n\t\t\t\t"} buyer: NOTANDY {"\n\t\t\t\t"} final bid: $36.66 </Text>
            <Text style={styles.otherText}>{"\t\t\t\t"}you are won this {"\n\t\t\t"} auction!</Text>
            <View style={styles.buySellButton}><SellingButton></SellingButton></View>
        </View>
    );
}
